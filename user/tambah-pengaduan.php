            ...
            <div class="card-body">
              ...
              ?>
                    <form class="row g-3" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="col-md-6">
                        <label for="" class="form-label-md"><b>Pilih Kategori Aduan</b></label>
                        <select name="kategori_aduan" class="form-control" id="">
                          <option> -- </option>
                          <?php 
                            $get_kategori = mysqli_query($conn, "SELECT * FROM kategori");
                            while ($x = mysqli_fetch_array($get_kategori)) {
                          ?>
                          <option value="<?php echo $x['kategori'] ?>"><?php echo $x['kategori'] ?></option>
                          <?php } ?>
                        </select>
                      </div>
                      <div class="col-md-6">
                        <label for="" class="form-label-md"><b>Pilih Petugas Tujuan</b></label>
                        <select name="petugas" class="form-control" id="">
                          <option> -- </option>
                          <?php 
                            $get_petugas = mysqli_query($conn, "SELECT * FROM petugas");
                            while ($x = mysqli_fetch_array($get_petugas)) {
                          ?>
